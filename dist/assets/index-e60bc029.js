...
let __tla = Promise.all([
      ...
      const listener = (message) => {
        ...
        if (((_a = message.data) == null ? void 0 : _a.type) === "REQUEST_SIGNATURE") {
          window.mina.signFields({
            ...
            if (response == null ? void 0 : response.signature) {
              this.worker.postMessage({
  ...
  AuroSigner = class AuroSigner extends AppChainModule {
    async sign(signatureData) {
      const { Signature } = await __vitePreload(() => import("./index-bddb4d40.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.a2), true ? ["assets/index-bddb4d40.js","assets/index-ec37013e.css"] : void 0);
      return await new Promise(async (resolve, reject) => {
        const listener = async (message) => {
          ...
          if (((_b = message.data) == null ? void 0 : _b.type) == "ERROR_SIGNATURE") {
            self.removeEventListener("message", listener);
            return reject();
          }
        };
