...
let __tla = Promise.all([
  ...
  AuroSigner = class AuroSigner extends AppChainModule {
    async sign(signatureData) {
      const { Signature } = await __vitePreload(() => import("./index-c91346d7.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.a2), true ? ["assets/index-c91346d7.js","assets/index-ec37013e.css"] : void 0);
